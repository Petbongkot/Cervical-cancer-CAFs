...
#Part3
  ?estimateScore
  estimateScore("gene_expression.gct", "EstimateScore63514.gct", platform = "affymetrix")
## Check arguments
  stopifnot(is.character("gene_expression.gct") && length("gene_expression.gct") == 1 && nzchar("gene_expression.gct"))
...
#Part4: Plot
  plotPurity("EstimateScore63514.gct",
                         samples="all_samples",
                         platform = "affymetrix",
